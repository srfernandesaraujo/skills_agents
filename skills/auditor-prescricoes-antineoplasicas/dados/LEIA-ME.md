# 📂 Pasta de Referências e Dados (/dados)

Esta pasta foi criada para armazenar arquivos de referência teóricos e contextuais para a Skill **"Auditor de Prescrições antineoplásicas"**.

## 🎯 O que colocar aqui (Recomendado para esta Skill)?
* **Diretrizes e Protocolos Clínicos**: Artigos científicos da ementa, guidelines de conselhos ou consensos profissionais (ex: Anamnese Farmacêutica, Diretriz da SBC).
