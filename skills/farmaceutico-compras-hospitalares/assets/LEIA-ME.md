# 🎨 Pasta de Mídias e Recursos Visuais (/assets)

Esta pasta serve para armazenar mídias de apoio visual para a Skill **"Farmacêutico especializado em compras hospitalares"**.

## 🎯 O que colocar aqui (Recomendado para esta Skill)?
* **Fluxogramas de Decisão Clínica**: Imagens de algoritmos de conduta ou exames para auxiliar na simulação de anamnese farmacêutica.
