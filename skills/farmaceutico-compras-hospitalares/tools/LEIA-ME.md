...
Esta pasta armazena os scripts Python executáveis (`.py`) que servem como ferramentas (tools) lógicas para a Skill **"Farmacêutico especializado em compras hospitalares"**.
